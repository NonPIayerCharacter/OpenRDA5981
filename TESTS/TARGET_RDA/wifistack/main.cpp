...
int my_smartconfig_handler(void *data, unsigned short data_len)
{
...
int main() {
    ...
    osDelay(1000);
    rda59xx_send_nulldata(1);
    rda59xx_set_channel(11);
    rda59xx_send_rawdata(data, sizeof(data));
    rda59xx_send_rawdata(data, sizeof(data));
    rda59xx_send_rawdata(data, sizeof(data));
    rda59xx_send_rawdata(data, sizeof(data));
    rda59xx_send_rawdata(data, sizeof(data));
    //printf("channel %d\r\n", wifi.get_channel());
    rda59xx_set_channel(wifi.get_channel());
    rda59xx_send_nulldata(0);

    osDelay(3000);
    rda59xx_sniffer_enable((sniffer_handler_t)my_smartconfig_handler);
